...
export default function EmployeeEngagementHeroSection() {
  return (
    <section
          ...
          <div className="grid grid-cols-1 items-center gap-12 min-[992px]:grid-cols-2 min-[992px]:gap-12">
            <div className="w-full max-w-[40rem]">
              <h1 className="m-0 text-[2.25rem] leading-[1.1] font-normal tracking-[-0.06rem] text-[#221e26] min-[768px]:text-[3rem] min-[768px]:tracking-[-0.12rem] min-[992px]:text-[3.875rem] min-[992px]:tracking-[-0.155rem]">
                Celebrate, recognize, and retain top talent with the{" "}
                <span className="text-[#5d209f]">
                  #1 Employee Engagement gifting platform
                </span>
              </h1>
              ...
              <p className="m-0 text-base leading-[1.5] font-light text-[#524f55] min-[768px]:text-[1.125rem]">
                Turn everyday employee moments into unforgettable experiences
                with SwagDrive&apos;s Employee Engagement Platform. Automate
                personalized corporate gifting and swag to welcome new hires,
                celebrate milestones, and reinforce company culture—all while
                saving time and boosting retention.
              </p>
            ...
            <div className="w-full overflow-hidden rounded-2xl min-[992px]:rounded-[1rem]">
              ...
              <img
                ...
                alt="Employee engagement gifting"
