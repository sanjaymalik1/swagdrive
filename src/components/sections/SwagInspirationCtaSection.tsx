...
export default function SwagInspirationCtaSection() {
  return (
    <section className="relative overflow-hidden bg-blue-primary">
      ...
      <div className="relative z-[1] mx-auto flex w-full max-w-[1440px] flex-col items-center px-5 py-16 text-center min-[480px]:px-10 min-[992px]:py-24">
        <h2 className="mx-auto m-0 mb-8 max-w-[42rem] font-[family-name:var(--font-satoshi)] text-[1.75rem] leading-[1.2] font-bold text-yellow-secondary min-[768px]:mb-11 min-[768px]:text-[2.5rem] min-[1025px]:text-[3.125rem] min-[1025px]:leading-[1.15]">
