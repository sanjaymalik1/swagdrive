...
export default function EventsFulfillmentHeroSection() {
  return (
    <section
      className="font-[family-name:var(--font-lexend)] text-[#524f55]"
      style={{
        backgroundImage:
          "url(/platform/crm/grid-bg.svg), linear-gradient(93deg, #e2e1ca, #f6f5e5)",
          ...
          <div className="grid grid-cols-1 items-center gap-12 min-[992px]:grid-cols-2 min-[992px]:gap-12">
            <div className="w-full max-w-[40rem]">
              ...
              <p className="m-0 text-base leading-[1.5] font-light text-[#524f55] min-[768px]:text-[1.125rem]">
                <strong className="font-medium text-[#221e26]">
