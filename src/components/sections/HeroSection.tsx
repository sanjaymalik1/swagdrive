...
export default function HeroSection() {
  return (
    <section className="bg-surface px-5 pt-16 pb-6 font-[family-name:var(--font-lexend)] min-[480px]:px-10 min-[480px]:pt-24">
      <div className="mx-auto flex w-full max-w-7xl flex-col">
        <div className="mx-auto flex w-full max-w-3xl flex-col items-center text-center">
          <h1 className="m-0 text-[2.5rem] leading-[1.1] font-normal tracking-[-0.09rem] text-blue-primary min-[768px]:text-[3rem] min-[768px]:tracking-[-0.12rem] min-[992px]:text-[3.875rem] min-[992px]:tracking-[-0.155rem]">
            ...
            <br />
            <span className="bg-[linear-gradient(92deg,var(--yellow-primary),var(--blue-secondary)_89.72%)] bg-clip-text text-transparent">
              Global Gifting &amp; Swag
            </span>
          </h1>
          ...
          <p className="m-0 max-w-3xl text-center text-base leading-[1.4] font-light text-muted-foreground min-[768px]:text-[1.125rem]">
          ...
          <Link
            href="/contact"
            className="inline-block rounded-[3rem] bg-yellow-primary px-6 py-4 text-center text-base leading-none font-normal text-blue-primary no-underline transition-colors hover:bg-yellow-secondary active:brightness-95"
          >
            Book a demo
          </Link>
        </div>
