...
export function KudosTabIcon() {
  return (
    <svg
      ...
      aria-hidden
    >
      <circle cx="33.5" cy="17.5" r="8.5" stroke="#04326E" strokeWidth="1.8" />
      <circle cx="17.5" cy="33.5" r="8.5" stroke="#04326E" strokeWidth="1.8" />
      <circle cx="33.5" cy="14.8" r="1.8" fill="#04326E" />
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="17.5" cy="30.8" r="1.8" fill="#04326E" />
      <path
