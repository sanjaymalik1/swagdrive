const TEAMS = [
  {
    ...
    badgeClass: "bg-yellow-secondary text-blue-primary",
  },
  {
    company: "JustWorks",
    useCase: "Events",
    ...
    badgeClass: "bg-blue-primary text-yellow-secondary",
  },
  {
          ...
          {TEAMS.map((team) => (
            ...
            >
              ...
              <div className="px-6 pb-6 min-[768px]:px-[30px] min-[768px]:pb-6">
                ...
                <h3 className="m-0 mt-2 py-2 font-[family-name:var(--font-satoshi)] text-xl leading-[1.2] font-semibold text-blue-primary min-[768px]:text-2xl">
                  {team.useCase}
                </h3>
