...
export default function SwagManagementHeroSection() {
  return (
    <section
        ...
        <div className="mx-auto w-full max-w-7xl">
          <div className="grid grid-cols-1 items-center gap-12 min-[992px]:grid-cols-2 min-[992px]:gap-12">
            <div className="w-full max-w-[40rem]">
              <p className="m-0 text-sm leading-snug font-medium text-[#943eff] min-[768px]:text-base">
                SwagDrive: The ultimate gifting and swag solution for customer
                success teams
              </p>
              ...
              <h1 className="m-0 text-[2.25rem] leading-[1.1] font-normal tracking-[-0.06rem] text-[#221e26] min-[768px]:text-[3rem] min-[768px]:tracking-[-0.12rem] min-[992px]:text-[3.875rem] min-[992px]:tracking-[-0.155rem]">
                Your ultimate swag solution: source, store &amp; ship with ease
              </h1>

              <div className="pt-3 min-[768px]:pt-4 min-[992px]:pt-6" />

              <p className="m-0 text-base leading-[1.5] font-light text-[#524f55] min-[768px]:text-[1.125rem]">
                Say goodbye to vendor chaos and inventory headaches.
                SwagDrive&apos;s all-in-one international swag management
                solution helps you source, store, ship, and sell premium branded
                merchandise while maximizing engagement from day one.
              </p>
            ...
            <div className="w-full overflow-hidden rounded-2xl min-[992px]:rounded-[1rem]">
              ...
              <img
                src="/capabilities/swag-management/hero.avif"
