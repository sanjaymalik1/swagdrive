  ...
  return (
    <section className="bg-surface">
      <div className="mx-auto w-full max-w-[1440px] px-5 py-16 min-[480px]:px-10 min-[992px]:py-24">
        <h2 className="m-0 mb-8 text-center font-[family-name:var(--font-satoshi)] text-2xl leading-[1.2] font-bold text-black min-[768px]:mb-12 min-[768px]:text-[2.375rem] min-[992px]:text-[3rem]">
        ...
        <div className="grid grid-cols-1 gap-5 min-[768px]:grid-cols-2 min-[768px]:gap-5 min-[992px]:gap-12">
          {PROGRAMS.map((program) => (
            <article
              key={program.title}
              className="flex cursor-pointer flex-col overflow-hidden rounded-[24px] min-[768px]:flex-row min-[768px]:items-stretch"
            >
              <div className="flex flex-col justify-center bg-blue-secondary px-5 py-6 min-[768px]:w-1/2 min-[768px]:px-6 min-[768px]:py-7 min-[992px]:px-7 min-[992px]:py-8">
                <h3 className="m-0 mb-4 font-[family-name:var(--font-satoshi)] text-[21px] leading-[1.2] font-semibold text-yellow-secondary min-[992px]:text-[28px]">
                  {program.title}
                </h3>
                <p className="m-0 font-[family-name:var(--font-overpass)] text-sm leading-[1.4] text-white min-[768px]:text-base">
                  {program.description}
                </p>
              </div>
