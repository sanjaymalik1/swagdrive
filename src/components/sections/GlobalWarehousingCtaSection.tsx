...
export default function GlobalWarehousingCtaSection() {
  return (
    <section className="relative overflow-hidden bg-blue-primary">
      ...
      <div className="relative z-[1] mx-auto flex w-full max-w-[1440px] flex-col items-center px-5 py-16 text-center min-[480px]:px-10 min-[992px]:py-24">
        <h2 className="mx-auto m-0 mb-4 max-w-[52rem] font-[family-name:var(--font-satoshi)] text-[1.625rem] leading-[1.25] font-bold text-yellow-secondary min-[768px]:mb-5 min-[768px]:text-[2rem] min-[768px]:leading-[2.625rem] min-[1025px]:text-[3.125rem] min-[1025px]:leading-[3.4375rem]">
          Ready to streamline your global gifting and swag logistics?
        </h2>
        <p className="mx-auto m-0 mb-8 max-w-[36rem] font-[family-name:var(--font-overpass)] text-base leading-[1.5] text-white min-[768px]:mb-11 min-[768px]:text-lg">
          Let us handle the complexities so you can focus on what matters
